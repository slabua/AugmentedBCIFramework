...
// SLB
void RobotController::playmotion(string motion) {

	clientTCP *conn	= new clientTCP(RobotPort, RobotIP);
	string command	= "playmotion " + motion + ".txt";
	conn->sendCommandToRobot(command.c_str());
...
// SLB
void RobotController::playvoice(string voice) {

	clientTCP *conn	= new clientTCP(RobotPort, RobotIP);
	string command	= "playvoice " + voice + ".wav";
	conn->sendCommandToRobot(command.c_str());
